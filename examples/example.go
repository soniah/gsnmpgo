...
func main() {
	...
	// netapp
	// snmpget -On -Oq -v1 -c enf0r5er 172.18.179.234 1.3.6.1.4.1.789.1.5.4.1.17.488  1.3.6.1.4.1.789.1.5.4.1.11.315
	uri := `snmp://enf0r5er@172.18.179.234//(1.3.6.1.4.1.789.1.5.4.1.11.315)`
